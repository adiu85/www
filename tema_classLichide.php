...
$array_objects = array("0" => new Liquid("apa", "y"), "1" => new Liquid("petrol", "n"), "2" => new Liquid("vodca", "y"), "3" => new Liquid("acid", "n"), "4" => new Liquid("diluant", "n"),"5"=> new Liquid("bere","y"),"6"=>new Liquid("rom","y"),"7"=>new Liquid("GPL","n"),"8"=>new Liquid("freon","n"),"9"=>new Liquid("lapte","y"),"10"=>new Liquid("suc","y"));
